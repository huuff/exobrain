...
* [[streams]] use a [[redis/hash|hash-like]] data structure, while [[pub-sub|pub-sub]] just allows any string whose structure must be managed at the application layer.
